<?php
	$owner_email='ventas@internacionalderepuestos.com.ec';
	...
	if(isset($_POST['name']) and $_POST['name'] != ''){$message_body .= '<p>Visitante: ' . $_POST['name'] . '</p>' . "\n" . '<br>' . "\n"; $subject.=$_POST['name'];}
	if(isset($_POST['email']) and $_POST['email'] != ''){$message_body .= '<p>Email: ' . $_POST['email'] . '</p>' . "\n" . '<br>' . "\n"; $user_email=$_POST['email'];}
	if(isset($_POST['direccion']) and $_POST['direccion'] != ''){$message_body .= '<p>Dirección: ' . $_POST['direccion'] . '</p>' . "\n" . '<br>' . "\n";}
	if(isset($_POST['pais']) and $_POST['pais'] != ''){$message_body .= '<p>Pais: ' . $_POST['pais'] . '</p>' . "\n" . '<br>' . "\n";}
	if(isset($_POST['ciudad']) and $_POST['ciudad'] != ''){$message_body .= '<p>Ciudad: ' . $_POST['ciudad'] . '</p>' . "\n" . '<br>' . "\n";}
	if(isset($_POST['phone']) and $_POST['phone'] != ''){$message_body .= '<p>Teléfono: ' . $_POST['phone'] . '</p>' . "\n" . '<br>' . "\n";}	
